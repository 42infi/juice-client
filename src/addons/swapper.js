...
const initResourceSwapper = () => {
  protocol.registerFileProtocol("cokeclient", (request, callback) =>
    callback({ path: request.url.replace("cokeclient://", "") })
  );
  ...
  let folder_regex_generator = "CokeClient[\\\\/]swapper[\\\\/]assets[\\\\/](";
