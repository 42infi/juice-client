...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const lobbyKeybindReminder = (settings) => {
        ...
        document.addEventListener("coke-settings-changed", ({detail}) => {
    ...
    const handleProfile = () => {
        ...
        const interval = setInterval(() => {
          ...
          `;
                    div.innerHTML = `
          <img src="" style="height: 0.8rem; width: auto;" />
          <span style="font-size: 1rem; font-weight: 600; color: #fff;">Coke Client Developer</span>
          `;
        ...
        const interval = setInterval(() => {
            ...
            if (settings.customizations) {
                ...
                `;
                        ...
                        if (customs.discord) addBadge("");
                        if (customs.booster) addBadge("");
